...
botao_login_entrar = ctk.CTkButton(frame_login, text= "Entrar no sistema", command= login_autent, font= ("Roboto",17))
botao_login_entrar.pack(padx=10, pady=2)

frame_principal = ctk.CTkFrame(screen)
texto_apresentacao = ctk.CTkLabel(frame_principal, text= "Bem vindo a Bibliotec:", font= ("Roboto",19))
texto_apresentacao.grid(row=0, column=1, padx= 10, pady=10)
botao_principal_sair= ctk.CTkButton(frame_principal, text= "Voltar", command= mostrar_tela_login, font= ("Roboto",14))
